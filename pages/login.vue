<template>
  <main>
    ...
    <div class="architectural-bg"></div>
    
    <div class="auth-container" :class="{paddingClass}">
      <div class="auth-card " :class="{ flipping: isTransitioning }">
        <div class="corner-top-right"></div>
        <div class="corner-bottom-left"></div>
        
        <div class="logo-section">
          <div class="mcx-logo">MCX</div>
          <div class="roman-numerals">MMXXV</div>
          <h1 class="welcome-title" v-html="currentTitle"></h1>
          <p class="welcome-subtitle">{{ currentSubtitle }}</p>
          <div class="divider"></div>
        </div>

        <div class="form-container">
          <Transition name="fade" mode="out-in">
            <div v-if="!isTransitioning" key="form">
              <!-- Messages -->
