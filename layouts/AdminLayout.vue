...
const windowWidth = ref(import.meta.client ? window.innerWidth : "");
...
const links = ref([
  { name: "Links", url: "/admin", icon: "ri:menu-line" },
  { name: "Appearance", url: "/admin/appearance", icon: "ri:shape-2-fill" },
  { name: "Analytics", url: "/", icon: "ri:bar-chart-fill" },
  { name: "Settings", url: "/", icon: "ri:settings-3-fill" },
]);
...
const linksMobile = ref([
  { name: "Links", url: "/admin", icon: "ri:menu-line" },
  { name: "Appearance", url: "/admin/appearance", icon: "ri:shape-2-fill" },
  { name: "Preview", url: "/admin/preview", icon: "ri:shape-2-fill" },
  { name: "Analytics", url: "/", icon: "ri:bar-chart-fill" },
  { name: "More", url: "/admin/more", icon: "", img: "https://picsum.photos/id/8/300/320" },
]);
        ...
        <div class="flex items-center justify-start w-full max-w-[500px]">
          <NuxtLink to="/admin">
            <img
              ...
              src="~/assets/images/demo/linktree-logo-icon.png"
            >
          </NuxtLink>
