...
<template>
  <div id="AuthLayout" class="h-screen w-full flex justify-between">
    ...
    <div class="lg:block hidden w-1/3 pointer-events-none">
        <img
        v-if="route.fullPath ==='/'" class="object-cover w-full h-screen select-none" src="~/assets/images/demo/side1.png" alt="side1">
        <img
        v-else="route.fullPath ==='/'" class="object-cover w-full h-screen select-none" src="~/assets/images/demo/side2.png" alt="side2">
    </div>
  </div>
</template>
